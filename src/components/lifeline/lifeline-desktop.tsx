    ...
    >
      ...
      */}
      <div
        ...
        // Volumes are tall enough that the track usually overflows the
        // stage, and plain centring then pushes the year and month
        // labels up behind the masthead. `safe center` falls back to
        // start-alignment exactly in that case, so the head of the rail
        // always stays on screen — worth applying in page mode too, not
        // only when embedded.
      ...
      >
        ...
        >
          {/*
            ...
            `bg-[var(--paper)]` to match the framing the shell puts
          ...
          */}
          <div
            ...
            style={{
              width: LIFELINE_STICKY_SHIELD_WIDTH,
