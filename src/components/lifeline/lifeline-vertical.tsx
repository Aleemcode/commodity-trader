...
function LifelineVerticalEvent({ event }: { event: LifelineEvent }) {
  ...
  if (volume) {
    return <LifelineVolumeCard volume={volume} width={168} />
  }

  return <LifelineVerticalTextEvent event={event} />
}

function LifelineVerticalTextEvent({ event }: { event: LifelineEvent }) {
